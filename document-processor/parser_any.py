        ...
        with pdfplumber.open(path) as pdf:
            ...
            for page_num, page in enumerate(pdf.pages, 1):
                ...
                if text.strip():
                    ...
                    blocks.append({"doc_id": doc_id, "chunk_id": chunk_id, "section": f"Page {page_num}", "level": 0, "type": "paragraph", "text": md_text, "metadata": {"page": page_num}})
